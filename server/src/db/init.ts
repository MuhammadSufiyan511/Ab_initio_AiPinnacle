...
const RAW_DB_NAME = process.env.DB_NAME || 'ab_initio_lms'
const DB_NAME_REGEX = /^[a-zA-Z_][a-zA-Z0-9_]{0,63}$/
if (!DB_NAME_REGEX.test(RAW_DB_NAME)) {
  throw new Error(`FATAL: Invalid DB_NAME "${RAW_DB_NAME}". Must match ${DB_NAME_REGEX}.`)
}
const DB_NAME = RAW_DB_NAME
