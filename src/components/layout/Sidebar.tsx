...
import {
  ...
  Award, ChevronLeft, ChevronRight, FileQuestion
} from 'lucide-react'
      ...
      <div className="flex items-center gap-3 px-4 h-16 border-b flex-shrink-0" style={{ borderColor: 'var(--border-color)' }}>
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              PrepPro<span className="text-brand-600 dark:text-brand-400 text-[10px] font-sans font-bold align-super ms-0.5">.Academy</span>
            </motion.span>
          )}
        </AnimatePresence>
      </div>
