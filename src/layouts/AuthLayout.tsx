  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--bg-base)' }}>
      ...
      >
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          />
           <span className="text-white font-bold text-xl">
             PrepPro<span className="text-brand-400 text-xs font-sans font-bold align-super ms-0.5">.Academy</span>
           </span>
        </div>
        ...
        {/* Testimonial */}
        <div className="relative z-10 glass rounded-2xl p-5" dir="ltr">
        ...
        <div className="flex justify-between items-center px-8 py-5 lg:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold" style={{ color: 'var(--text-primary)' }}>
              PrepPro<span className="text-brand-600 text-xs font-sans font-bold align-super ms-0.5">.Academy</span>
            </span>
          </div>
          <div className="flex items-center gap-2">
            <LanguageToggle />
