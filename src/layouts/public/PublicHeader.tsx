        ...
        <div className="mx-auto max-w-7xl rounded-full border bg-[var(--bg-surface)]/90 shadow-[0_14px_50px_rgba(15,35,74,0.12)] backdrop-blur-2xl" style={{ borderColor: 'var(--border-color)' }}>
          <div className="flex h-16 items-center justify-between gap-2 px-3 sm:h-18 sm:gap-4 sm:px-6">
            <Link to="/" className="flex min-w-0 shrink items-center gap-2 transition-opacity hover:opacity-90 sm:gap-3">
              ...
              />
              <span className="inline truncate text-sm font-extrabold tracking-tight sm:text-xl">
                PrepPro<span className="text-brand-600 dark:text-brand-400 text-[10px] sm:text-xs font-sans font-bold align-super ms-0.5 tracking-[0.5px]">.Academy</span>
              </span>
            </Link>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed end-0 top-0 bottom-0 z-50 flex w-80 max-w-[90vw] flex-col gap-5 border-l bg-[var(--bg-surface)] p-5 shadow-2xl lg:hidden sm:p-6"
              style={{ borderColor: 'var(--border-color)' }}
            >
                  ...
                  />
                   <div className="min-w-0">
                     <span className="block truncate text-sm font-extrabold">
                       PrepPro<span className="text-brand-600 dark:text-brand-400 text-[9px] font-sans font-bold align-super ms-0.5">.Academy</span>
                     </span>
