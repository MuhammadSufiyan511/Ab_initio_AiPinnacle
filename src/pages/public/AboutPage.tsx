...
export default function AboutPage() {
  ...
  return (
    <>
    <Helmet>
      <title>About PrepPro Academy — Our Mission, Story & Team</title>
      <meta name="description" content="Learn about PrepPro Academy — Pakistan's AI-powered exam preparation platform. Founded by FPSC qualifiers to make premium mock tests free for every candidate." />
      <meta name="keywords" content="PrepPro Academy about, FPSC prep platform Pakistan, AI exam prep story, PrepPro founders, educational technology Pakistan" />
      <link rel="canonical" href="https://preppro.academy/about" />
      <meta property="og:type" content="article" />
      <meta property="og:url" content="https://preppro.academy/about" />
      <meta property="og:title" content="About PrepPro Academy — Our Mission & Story" />
      <meta property="og:description" content="Learn about PrepPro Academy — Pakistan's AI-powered exam preparation platform founded by FPSC qualifiers." />
      <meta property="og:image" content="https://preppro.academy/og-image.png" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="About PrepPro Academy — Our Mission & Story" />
      <meta name="twitter:description" content="Learn about PrepPro Academy — Pakistan's AI-powered exam preparation platform founded by FPSC qualifiers." />
      <meta name="twitter:image" content="https://preppro.academy/og-image.png" />
      <link rel="alternate" hrefLang="en" href="https://preppro.academy/about" />
      <link rel="alternate" hrefLang="ur" href="https://preppro.academy/about?lang=ur" />
      <link rel="alternate" hrefLang="x-default" href="https://preppro.academy/about" />
      <script type="application/ld+json">
      {`{
        "@context": "https://schema.org",
        "@type": "AboutPage",
        "name": "About PrepPro Academy",
        "description": "Learn about PrepPro Academy — Pakistan's AI-powered exam preparation platform",
        "url": "https://preppro.academy/about",
        "mainEntity": {
          "@type": "Organization",
          "name": "PrepPro Academy",
          "url": "https://preppro.academy",
          "description": "Pakistan's leading AI-powered exam preparation platform for FPSC, PPSC, SPSC, BPSC, CSS and competitive assessments"
        }
      }`}
      </script>
    </Helmet>
